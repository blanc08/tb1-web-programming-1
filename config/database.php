...
class Database
{
    ...
    private $db_pass = '';
    private $db_name = 'tb1_aplikasi_ujian';
    private $con;

    public function __construct($db_host = 'localhost', $db_user = 'root', $db_pass = '', $db_name = 'tb1_aplikasi_ujian')
    {
    ...
    public function connect()
    {
        if (!$this->con) {
            ...
            $this->con = mysqli_connect($this->db_host, $this->db_user, $password);
            if ($this->con) {
    ...
    public function query($q): mysqli_result|bool
    {
