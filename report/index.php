...
<head>
    ...
    <link rel="apple-touch-icon" href="/tb1-web-programming-1/assets/img/apple-icon.png">
    <link rel="shortcut icon" type="image/x-icon" href="/tb1-web-programming-1/assets/img/favicon.ico">
    <!-- Load Require CSS -->
    ...
    <!-- Datatable -->
    <link rel="stylesheet" href="/tb1-web-programming-1/assets/DataTables/datatables.css">
...
<body>
    ...
    $mysqli->connect();
    $scores = $mysqli->query("
        SELECT *, users.nama AS nama_siswa, quizzes.nama AS nama_tryout FROM review_nilai
        INNER JOIN users ON users.id = review_nilai.userId
        INNER JOIN quizzes ON quizzes.id = review_nilai.quizId
        ORDER BY review_nilai.id DESC"
    );
                ...
                <div class=" mt-5 border-0 shadow card">
                    <div class="card-body">
                        <table id="table" class="w-100 table light-300">
                            ...
                            <tbody>
                                <?php while ($value = mysqli_fetch_assoc($scores)): ?>
                                    <tr>
                                        <td>
                                            <?= $value['nama_siswa'] ?>
                                        </td>
    ...
    <!-- Datatables -->
    <script src="/tb1-web-programming-1/assets/DataTables/datatables.js"></script>
    <!-- Isotope -->
